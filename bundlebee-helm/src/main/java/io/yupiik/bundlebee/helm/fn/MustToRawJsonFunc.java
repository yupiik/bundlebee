...
// category = JSON/YAML
//metadata:end
@Description("Encodes a value to raw JSON, throws on error")
public class MustToRawJsonFunc implements io.yupiik.bundlebee.helm.HelmFunction {
    @Override
    public String name() {
        return "mustToRawJson";
    }
    ...
    public Object execute(final Object... args) {
        ...
        return toRawJson(value);
    }

    private String toRawJson(final Object value) {
        final var factory = Json.createGeneratorFactory(Map.of(
