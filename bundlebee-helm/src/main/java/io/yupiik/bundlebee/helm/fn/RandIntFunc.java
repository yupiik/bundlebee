...
public class RandIntFunc implements HelmFunction {
    @Override
    public String name() {
        return "randInt";
    }
    ...
    public Object execute(final Object... args) {
        if (args == null || args.length < 1) {
            throw new IllegalArgumentException("randInt requires one argument");
        }
        return new Random().nextInt(((Number) args[0]).intValue());
    }
