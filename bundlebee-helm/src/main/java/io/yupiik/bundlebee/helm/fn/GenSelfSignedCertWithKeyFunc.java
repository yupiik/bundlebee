...
// category = Crypto
//metadata:end
@Description("Generates a self-signed cert with a given key")
public class GenSelfSignedCertWithKeyFunc implements HelmFunction {
    @Override
    public String name() {
        return "genSelfSignedCertWithKey";
    }
    ...
    public Object execute(final Object... args) {
        if (args.length < 2 || args[0] == null || args[1] == null) {
            throw new IllegalArgumentException("genSelfSignedCertWithKey requires at least cn and key arguments");
        }
        ...
        try {
            ...
            throw new IllegalStateException("Failed to generate self-signed certificate with provided key", e);
        }
    }
