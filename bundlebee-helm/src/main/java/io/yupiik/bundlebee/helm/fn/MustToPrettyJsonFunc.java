...
// category = JSON/YAML
//metadata:end
@Description("Encodes a value to pretty JSON, throws on error")
public class MustToPrettyJsonFunc implements io.yupiik.bundlebee.helm.HelmFunction {
    @Override
    public String name() {
        return "mustToPrettyJson";
    }
