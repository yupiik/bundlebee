...
// category = Crypto
//metadata:end
@Description("Generates a CA with a given private key")
public class GenCAWithKeyFunc implements HelmFunction {
    @Override
    public String name() {
        return "genCAWithKey";
    }
    ...
    public Object execute(final Object... args) {
        if (args.length < 3 || args[0] == null || args[1] == null || args[2] == null) {
            throw new IllegalArgumentException("genCAWithKey requires cn, days, and key arguments");
        }
        final var cn = args[0].toString();
        final var days = toInt(args[1]);
        final var keyPem = args[2].toString();
        ...
        try {
            ...
            throw new IllegalStateException("Failed to generate CA certificate with provided key", e);
        }
    }
